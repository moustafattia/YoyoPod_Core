use yoyopod_voip_host::host::BackendEvent;
use yoyopod_voip_host::liblinphone::{EventQueue, LiblinphoneEvent};
...
fn liblinphone_backend_type_is_host_runtime_backend() {
    ...
    #[cfg(feature = "native-liblinphone")]
    assert_backend::<yoyopod_voip_host::liblinphone::LiblinphoneBackend>();
}
