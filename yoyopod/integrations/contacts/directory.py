"""People directory manager for mutable contacts and speed-dial state."""
...
class PeopleManager:
    ...
    @classmethod
    def from_config_manager(cls, config_manager) -> "PeopleManager":
        """Build one manager from the composed config manager paths."""
