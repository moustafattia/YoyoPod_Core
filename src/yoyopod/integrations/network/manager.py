"""App-facing network manager owned by the canonical network integration seam."""
...
from yoyopod.integrations.network.models import GpsCoordinate, ModemPhase, ModemState
