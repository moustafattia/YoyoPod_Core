"""src/yoyopod/cli/pi/power.py — PiSugar power and RTC commands."""
...
power_app = typer.Typer(name="power", help="PiSugar power and RTC commands.", no_args_is_help=True)
...
def battery(
    ...
    if not manager.config.enabled:
        logger.error("power backend disabled in yoyopod_config.yaml")
