"""src/yoyopod/cli/remote/setup.py - remote wrappers for repo-owned setup commands."""
...
from yoyopod.cli.remote.ops import _resolve_remote_config, run_remote, validate_config
